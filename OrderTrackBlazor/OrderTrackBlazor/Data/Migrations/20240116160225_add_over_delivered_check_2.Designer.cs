...
namespace OrderTrackBlazor.Migrations
{
    ...
    [Migration("20240116160225_add_over_delivered_check_2")]
    partial class add_over_delivered_check_2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderTrackBlazor.Entities.OrderTrackCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("OrderTrackCategories");
                });
            ...
            modelBuilder.Entity("OrderTrackBlazor.Entities.OrderTrackOrderItem", b =>
                {
                    ...
                    b.Property<bool>("OverDelivered")
                        .HasColumnType("bit");

                    b.Property<int>("OverDeliveredNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderTrackBlazor.Entities.OrderTrackProduction", b =>
                {
                    b.HasOne("OrderTrackBlazor.Entities.OrderTrackCategory", "Category")
